    ...
    public class Ps1Profile : Profile
    {
        protected override void Configure()
        {
            ...
            CreateMap<DAL.Entities.PurseSeineGear, Ps1ViewModel.FishingGear>()
                ...
                .ForMember(d => d.NetDepthUnits, 
                    o => o.MapFrom(s => s.NetDepthUnit.HasValue ? s.NetDepthUnit.Value.ToString() : string.Empty))
                .ForMember(d => d.NetMeshUnits,
                    o => o.MapFrom(s => s.MeshSizeUnits.HasValue ? s.MeshSizeUnits.Value.ToString() : string.Empty))
                ;
            ...
            CreateMap<DAL.Entities.PurseSeineVesselAttributes, Ps1ViewModel.VesselCharacteristics>()
                ...
                .ForMember(d => d.HelicopterRangeUnits, 
                    o => o.MapFrom(s => s.HelicopterRangeUnit.HasValue ? s.HelicopterRangeUnit.Value.ToString() : string.Empty))
                .AfterMap((s,d) => {
            ...
            CreateMap<DAL.Entities.PurseSeineTrip, Ps1ViewModel>()
                .ForMember(d => d.PermitNumbers, o => o.Ignore()) // TODO:  Where?
                ...
                .ForMember(d => d.Page1Comments, o => o.MapFrom(s => s.Comments))
